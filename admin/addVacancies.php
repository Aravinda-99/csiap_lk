...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($description === '') {
        ...
        try {
            ...
            // Insert vacancy
            $stmt = $pdo->prepare('INSERT INTO vacancies (description, published_date, closing_date) VALUES (?, ?, ?)');
...
<head>
    ...
    <title>Add Vacancy - Admin Panel</title>
    ...
    <main class="main-content">
        ...
        <header class="header">
            <div class="header-left">
                ...
                <h1 class="header-title">Add Vacancy</h1>
            </div>
        ...
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Add New Vacancy</h2>
                <p class="form-subtitle">Enter the description, dates, and attach advert images/PDFs</p>
            </div>
            ...
            <form method="POST" action="" id="add-vacancy-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="files">Attach Advert Files (Images or PDF)</label>
                ...
                <div class="form-buttons">
                    <a href="allVacancies.php" class="btn btn-secondary">
